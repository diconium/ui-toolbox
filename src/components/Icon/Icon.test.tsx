...
describe('Icon component', () => {
  ...
  test('can render all sizes correctly', () => {
    const { container: small } = render(<Icon icon="aperture" size="s" />);
    const { container: medium } = render(<Icon icon="aperture" size="m" />);
    const { container: large } = render(<Icon icon="aperture" size="lg" />);
    const { container: xlarge } = render(<Icon icon="aperture" size="xl" />);
