...
const DEFAULT_TEMPLATE = `text-toolbox-white bg-toolbox-secondary hover:bg-toolbox-secondary-600 
  active:bg-toolbox-secondary-600 active:text-toolbox-secondary-600 
  focus:outline-none focus-visible:border-toolbox-primary-300 focus-visible:border-3 
...
const OUTLINED_TEMPLATE = `text-toolbox-secondary bg-white border-3 border-toolbox-secondary text-toolbox-black
  ...
  focus:outline-none focus-visible:border-3 focus-visible:border-toolbox-primary-300 focus-visible:text-toolbox-secondary
